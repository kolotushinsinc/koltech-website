...
const AISolutions = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Анализ изображений и видео для автоматизации процессов',
                  ...
                  {[Brain, Bot, Eye, BarChart3].map((Icon, index) => (
                    ...
                    >
                      ...
                      <p className="text-white text-sm font-medium">
                        {['ML', 'Bots', 'Vision', 'Analytics'][index]}
                      </p>
                    </div>
                  ))}
                </div>
              ...
              >
                ...
                <div className="w-full bg-dark-700 rounded-full h-3 overflow-hidden">
                  <div 
                    ...
                    style={{ 
                      width: visibleElements.includes(index + 14) ? `${tech.level}%` : '0%',
                      transitionDelay: `${(index + 14) * 0.1}s`
                    }}
                  />
                </div>
              </div>
