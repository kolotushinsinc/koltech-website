        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-dark-800 p-8 rounded-2xl border border-dark-700 card-hover group"
              >
                <div className={`w-16 h-16 bg-gradient-to-br ${service.color} rounded-xl flex items-center justify-center mb-6 group-hover:animate-pulse`}>
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-primary-500/20 to-accent-purple/20 rounded-2xl flex items-center justify-center">
                <div className="text-center">
                  <Rocket className="w-24 h-24 text-primary-400 mx-auto mb-4 animate-float" />
