              ...
              <div className="w-full h-96 bg-gradient-to-br from-primary-500/20 to-accent-purple/20 rounded-3xl flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center">
                  <div className="relative">
                    <Lightbulb className="w-32 h-32 text-primary-400 mx-auto mb-6 animate-float" />
        ...
        <div className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-dark-800 border border-dark-700 rounded-2xl p-8 card-hover relative overflow-hidden slide-up"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Link
                    to="/contacts"
                    className={`w-full mt-6 bg-gradient-to-r ${service.color} text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 block text-center`}
                  >
                    Узнать больше
                  </Link>
                </div>
