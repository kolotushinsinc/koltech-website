            ...
            <div className="bg-dark-800/80 border border-dark-700 rounded-2xl p-8 mb-8 backdrop-blur-sm slide-up">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <h3 className="text-white font-semibold mb-2">Freelance Hub</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-white font-semibold mb-2">Startup Valley</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-white font-semibold mb-2">Investment Zone</h3>
