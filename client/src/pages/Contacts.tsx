        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactInfo.map((info, index) => (
              <div
                key={index}
                className="bg-dark-800 border border-dark-700 rounded-2xl p-6 card-hover group slide-up flex flex-col h-full"
              ...
              >
                ...
                <p className="text-gray-400 text-sm mt-auto">{info.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8 slide-up" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="bg-dark-800 border border-dark-700 rounded-2xl p-8">
                <h3 className="text-xl font-bold text-white mb-4">Наши офисы</h3>
                <div className="space-y-4">
                  <div className="text-gray-300">
                    <p className="font-semibold text-white mb-1">Санкт-Петербург</p>
                    <p className="text-sm">Россия, наб. канала Грибоедова, 19</p>
                  </div>
                  <div className="text-gray-300">
                    <p className="font-semibold text-white mb-1">Владивосток</p>
                    <p className="text-sm">Россия, Светланская ул., 33, (этаж 3)</p>
                  </div>
                  <div className="text-gray-300">
                    <p className="font-semibold text-white mb-1">Находка</p>
                    <p className="text-sm">«ПризмаТим Интернет-маркетинг». Адрес: ул. Арсеньева, 14</p>
                  </div>
                </div>
              </div>
