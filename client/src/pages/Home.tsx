          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
                ...
                {/* Мы — не студия и не агентство, а живая фрилансерская инициатива, объединённая стремлением делать по-настоящему интересные проекты. */}
              ...
              <p className="text-gray-300 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
                ...
                {/* KolTech связывает заказчиков с проверенными экспертами, создавая пространство для смелых технологических решений без бюрократии и рутины.  */}
